Locales['es'] = {
  ...
  ['blip_job'] = 'LSWM: Los Santos Waste Management (basura)', --'Garbage company',
  ['blip_delivery'] = 'LSWM : recogida', --'Garbage company : Delivery',
  ['blip_goal'] = 'LSWM : entrega', --'Garbage company : Delivery point',
